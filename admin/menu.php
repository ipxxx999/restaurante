...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.php">Restaurante | Resto</a>
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <hr>
          <p>Aquí podrá Administrar los diferentes menú del restaurante, y podrá Agregar, Modificar o Eliminar tus listas del Menú.</p>
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright © Restaurante Resto 2022</span>
            </div>
          </div>
        </footer>
